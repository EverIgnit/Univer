...
==================================================
Версия 2.2
	- Исправлено: поиск русских символов в DOS-кодировке, установка текущего каталога при открытии файла из командной строки и из меню "File" и др.;
...
HomePage: http://www.avt.newmail.ru
E-Mail: avt@newmail.ru (Anatoly Voznuk)
