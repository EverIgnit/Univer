...
public class Serializer {
    ...
    static void deserializeGroups() {
        try {
            InputStream is = new FileInputStream("C:\\Users\\1801080061\\Downloads\\PPSLab5,6\\Files\\Serialized\\Groups.bin");
    ...
    static void updateGroupFile() {
        try {
            String fName = "C:\\Users\\1801080061\\Downloads\\PPSLab5,6\\Files\\Serialized\\Groups.bin";
    ...
    static void updateAccounts() {
        try {
            String fName = "C:\\Users\\1801080061\\Downloads\\PPSLab5,6\\Files\\Serialized\\Accounts.bin";
            OutputStream os = new FileOutputStream(fName);
            ObjectOutputStream oos = new ObjectOutputStream(os);
    ...
    static void deserializeAccounts() {
        try {
            InputStream is = new FileInputStream("C:\\Users\\1801080061\\Downloads\\PPSLab5,6\\Files\\Serialized\\Accounts.bin");
            ObjectInputStream ois = new ObjectInputStream(is);
